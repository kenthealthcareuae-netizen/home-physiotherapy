    ...
    try {
      ...
      await emailjs.send(
        ...
        emailjsConfig.templateId,
        {
          ...
          phone: formData.phone.trim(),
          email: 'N/A',
          subject: 'Free Session Request - Home Physiotherapy Popup Form',
          message: `FORM METHOD: Home Physiotherapy Free Session Popup
...
Timestamp: ${new Date().toLocaleString('en-US', { timeZone: 'Asia/Dubai' })}`,
      ...
      if (typeof dataLayer !== 'undefined') {
        dataLayer.push({
          'event': 'home_physiotherapy_free_session_form_submission',
          'form_type': 'home_physiotherapy_free_session_popup',
      ...
      if (typeof fbq !== 'undefined') {
        fbq('track', 'Lead', {
          content_name: 'Home Physiotherapy Free Session Form Submission',
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6 relative overflow-hidden" dir="rtl">
