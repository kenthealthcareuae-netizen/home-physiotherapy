    ...
    try {
      ...
      await emailjs.send(
        ...
        emailjsConfig.templateId,
        {
          ...
          phone: formData.phone.trim(),
          email: 'N/A',
          subject: 'WhatsApp Lead - Home Physiotherapy Form Submission',
          message: `FORM METHOD: Home Physiotherapy WhatsApp Gateway
...
Timestamp: ${new Date().toLocaleString('en-US', { timeZone: 'Asia/Dubai' })}`,
      ...
      if (typeof dataLayer !== 'undefined') {
        dataLayer.push({
          'event': 'home_physiotherapy_whatsapp_form_submission',
          'form_type': 'home_physiotherapy_whatsapp_gateway',
      ...
      if (typeof fbq !== 'undefined') {
        fbq('track', 'Lead', {
          content_name: 'Home Physiotherapy WhatsApp Form Submission',
