    ...
    try {
      ...
      await emailjs.send(
        ...
        emailjsConfig.templateId,
        {
          ...
          subject: 'Lead from Home Physiotherapy Landing Page',
          message: `FORM METHOD: Home Physiotherapy Contact Form
...
Timestamp: ${new Date().toLocaleString('en-US', { timeZone: 'Asia/Dubai' })}`,
      ...
      if (typeof dataLayer !== 'undefined') {
        dataLayer.push({
          'event': 'home_physiotherapy_contact_form_submission',
          'form_type': 'home_physiotherapy_contact_form',
      ...
      if (typeof fbq !== 'undefined') {
        fbq('track', 'Lead', {
          content_name: 'Home Physiotherapy Contact Form Submission',
