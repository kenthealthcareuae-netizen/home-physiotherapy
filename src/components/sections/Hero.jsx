    ...
    try {
      ...
      await emailjs.send(
        ...
        { 
          ...
          subject:'Lead from Home Physiotherapy Hero Form',
          message: `FORM METHOD: Home Physiotherapy Hero Quick Booking
...
Timestamp: ${new Date().toLocaleString('en-US', { timeZone: 'Asia/Dubai' })}`,
      ...
      if (typeof dataLayer !== 'undefined') {
        dataLayer.push({
          'event': 'home_physiotherapy_hero_form_submission',
          'form_type': 'home_physiotherapy_hero_quick_booking',
      ...
      if (typeof fbq !== 'undefined') {
        fbq('track', 'Lead', {
          content_name: 'Home Physiotherapy Hero Form Submission',
          content_category: 'Home Healthcare',
          value: 0,
          currency: 'AED',
          gclid: gclid || localStorage.getItem('gclid')
        });
                ...
                {showForm ? (
                  ...
                  >
                    <h1 className="text-4xl md:text-6xl font-extrabold mb-8 text-center lg:text-right" dir="rtl">
                      <span className="block text-primary">العلاج الطبيعي في منزلك</span>
                      <span className="block gradient-text-alt">راحة وخصوصية مع أفضل النتائج</span>
                    </h1>
                    <p className="text-lg md:text-xl text-muted-foreground mb-12 max-w-2xl mx-auto lg:mr-0 leading-relaxed" dir="rtl">
                      احصل على خدمات العلاج الطبيعي المتخصصة في راحة منزلك. نقدم جلسات علاج طبيعي مخصصة لكبار السن وذوي الاحتياجات الخاصة، مع ضمان الراحة والخصوصية والنتائج الفعالة.
                    </p>
                    <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center lg:justify-start mb-10" dir="rtl">
                      ...
                      >
                        <ArrowRight className="mr-3 h-5 w-5"/> احجز جلستك المنزلية المجانية
                      </Button>
