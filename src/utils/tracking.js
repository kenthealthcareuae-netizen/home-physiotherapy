// Enhanced tracking utilities for home physiotherapy landing page
class TrackingManager {
  ...
  trackFormSubmission(formType, formData) {
    ...
    if (typeof fbq !== 'undefined') {
      fbq('track', 'Lead', {
        content_name: 'Home Physiotherapy Contact Form',
  ...
  trackPhoneCall(phoneNumber) {
    ...
    if (typeof fbq !== 'undefined') {
      fbq('track', 'Contact', {
        content_name: 'Home Physiotherapy Phone Call',
        content_category: 'Home Healthcare',
        gclid: this.gclid || localStorage.getItem('gclid')
      });
    }
  ...
  trackWhatsAppClick(phoneNumber) {
    ...
    if (typeof fbq !== 'undefined') {
      fbq('track', 'Contact', {
        content_name: 'Home Physiotherapy WhatsApp Click',
        content_category: 'Home Healthcare',
        gclid: this.gclid || localStorage.getItem('gclid')
      });
    }
